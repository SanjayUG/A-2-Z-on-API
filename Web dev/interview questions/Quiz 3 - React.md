...
4.  Which of the following is true about props in React?
    ...
    **Answer:** Props are immutable within the receiving component
...
5.  What is the primary purpose of useState in React functional components?
    ...
    **Answer:** To manage and preserve local state in a functional component
...
7.  What are props in React?
    ...
    **Answer:** Read-only inputs passed to components
...
9.  What is the primary difference between state and props in React?
    ...
    **Answer:** Props are passed to components; state is managed within the component
...
10. How do you update state in a functional component?
    ...
    **Answer:** useState returns a setter function
...
11. What does the `event.preventDefault()` method do in a React event handler?
    ...
    **Answer:** Prevents the default browser behavior for the event
...
12. Which of the following best describes React’s event system?
    ...
    **Answer:** React uses a synthetic event system for consistency across browsers
...
16. What happens when you update the state using the setter function (e.g., setCount) returned by useState?
    ...
    **Answer:** The component is re-rendered with the updated state
...
19. How do you update state in a class component?
    *   this.setState()
    *   this.state = {}
    *   useState()
    *   updateState()
...
20. Which lifecycle method is used in a class component to perform an action after the component mounts?
    *   componentDidUpdate()
    *   componentWillMount()
    *   componentDidMount()
    *   useEffect()
...
22. What is the purpose of the `package.json` file in a React (Node.js) project?
    ...
    **Answer:** It manages dependencies, scripts, and project metadata

---

23. Which of the following is not true about functional components?
    ...
    **Answer:** They do not support lifecycle methods

---

24. Which keyword is used to define state in a class component?
    *   let
    *   state
    *   this.state
    *   useState
...
25. Which of the following is true about `propTypes` in React?
    ...
    **Answer:** It validates the type of props passed to a component
...
26. How do you pass a prop named `title` with the value "Welcome" to a component?
    ...
    **Answer:** `<MyComponent title="Welcome" />`

---

27. In React synthetic events, how do you access the value of a text input on change?
    *   event.value
    *   event.target.value
    *   event.text
    *   event.input.value
